    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('date', DateType::class, [
                ...
                // Ajout de la contrainte de date minimale pour la réservation
            ...
            ->add('time', TimeType::class, [
                ...
                'required' => 'true',
                'widget' => 'choice',
                // Définition des plages horaires possibles en fonction des horaires d'ouverture et de fermeture
                'hours' => [11, 12, 18, 19, 20, 21],
                'minutes' => [00, 15, 30, 45]
            ])
