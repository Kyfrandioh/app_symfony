...
class ReservationController extends AbstractController
{
    ...
    public function hours(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        for($openingHours['noonOpening']; $openingHours['noonOpening'] < $openingHours['noonClosing']; 
        $openingHours['noonOpening']++) {
            $reservationHours[] = $openingHours['noonOpening'];
        }

        for($openingHours['eveningOpening']; $openingHours['eveningOpening'] < $openingHours['eveningClosing'];
         $openingHours['eveningOpening']++) {
